...
- **100〜150文字**、夜に読んで翌朝試したくなる内容。余分な説明は削る
...
3. **問いかけ（最終行）**: 「いくつ当てはまった？」「何位まで当てはまった？」「これ、心当たりある？」などの自然な問いかけで締める
...
- **150〜250文字**。詳細を伏せて「続きは鑑定で」と示唆してもOK
...
- **制限型の書き出しも有効（カリギュラ効果）**: 「〜な人には早すぎる情報かもしれない」「知ると今夜から試したくなるので、覚悟がある人だけ読んで」など、制限を設けてから知識を明かす
- 最後に「これ知ってた？」「試してみた人いる？」など問いかけを添えてコメントを促す
- **120〜160文字**。1つの事実に絞り、説明を広げない
