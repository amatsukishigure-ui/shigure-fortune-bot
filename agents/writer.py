...
### 選択肢のテーマ例（テーマに合わせて自由に変える）
- 気の状態: 「整ってきた → 🔮」vs「詰まってる → 🐉」
- 行動意欲: 「動きたい → ✨」vs「止まってる → 🌙」
- 悩みの種類: 「仕事・キャリア → 🔥」vs「恋愛・人間関係 → 💧」
- 転機の感覚: 「転機が近い気がする → ⭐」vs「まだ底にいる気がする → 🌿」
- 季節×気の流れ: 「梅雨に気が重い → 🌧️」vs「流れが変わってきた → 🌱」
...
- **末尾は命令形を使わない**: 「いいねして」「フォローして」「コメントして」は直接的すぎる。代わりに問いかけか余韻で自然に終わらせる
  - OK: 「いくつ当てはまった？」「わかる？」「これ、あなたのこと？」「心当たりある？」
  - OK: 問いかけなしで強い一文で締める（余白が読者を動かす）
